...
- [iSponsorBlock](https://github.com/Galactic-Dev/iSponsorBlock) - Block Sponsorsships on videos
...
- [YouLoop](https://github.com/bhackel/YouLoop) - Adds a player button to enable/disable looping on the current video.
